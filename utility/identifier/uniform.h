...
namespace parameters{
	...
	struct rayTracing{
		using type = bool;
		using unit_type = bool;
		static constexpr const uniforms identifier = uniforms::rayTracing;
	...
	struct auxScale{
		using type = float;
		using unit_type = float;
		static constexpr const uniforms identifier = uniforms::auxScale;
