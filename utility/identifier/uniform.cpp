...
bool* parameters::rayTracing::ptr = &HELPER_VARIABLErayTracing;
bool* parameters::rayTracing::unit_ptr = (bool*) &HELPER_VARIABLErayTracing;

static float HELPER_VARIABLEauxScale{1.f};
float* parameters::auxScale::ptr = &HELPER_VARIABLEauxScale;
float* parameters::auxScale::unit_ptr = (float*) &HELPER_VARIABLEauxScale;
