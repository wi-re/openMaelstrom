		...
		hostDevice int32_t s_loop() {
			if (s.beginning != -1) {
				...
				for (; ii < s.beginning + s.length;) {
					...
					jj = cs.beginning;
					if (full_loop ||
						position_to_morton(arrays.position[cs.beginning], arrays, 1.f) == morton) {
						if (cs_loop() != -1) {
							return neighbor_idx;
						}
					}
		...
		hostDevice int32_t s_loop() {
			if (s.beginning != -1) {
				...
				for (; ii < s.beginning + s.length;) {
					...
					jj = cs.beginning;
					if (full_loop ||
						position_to_morton_32(arrays.position[cs.beginning], arrays, 1.f) == morton) {
						if (cs_loop() != -1) {
							return neighbor_idx;
						}
					}
		...
		hostDevice int32_t s_loop() {
			if (s.beginning != -1) {
				...
				for (; ii < s.beginning + s.length;) {
					...
					jj = cs.beginning;
					if (full_loop ||
						position_to_morton(arrays.position[cs.beginning], arrays, factor) == morton) {
						if (cs_loop() != -1) {
							return neighbor_idx;
						}
					}
