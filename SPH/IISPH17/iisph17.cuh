...
namespace SPH{
	namespace IISPH17{
		struct Memory{
			...
			write_array_u<arrays::sourceTerm> sourceTerm;
			write_array_u<arrays::Aii> Aii;
			write_array_u<arrays::volumeError> volumeError;
			write_array_u<arrays::iisph17::omega> iisph17Omega;
			...
			using temporary_arrays = std::tuple<arrays::apparentVolume, arrays::sourceTerm, arrays::Aii, arrays::volumeError, arrays::iisph17::omega, arrays::predictedAcceleration, arrays::boundaryPressure>;
