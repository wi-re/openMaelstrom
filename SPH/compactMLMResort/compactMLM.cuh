...
namespace SPH{
	namespace compactMLM{
		struct Memory{
			...
			using output_arrays = std::tuple<arrays::compactCellSpan, arrays::compactHashMap, arrays::MLMResolution>;
			using temporary_arrays = std::tuple<arrays::resortIndex, arrays::particleparticleIndex, arrays::ZOrder_64, arrays::ZOrder_32, arrays::compactCellSpanSwap, arrays::cellparticleIndex, arrays::compactparticleIndex, arrays::resortArray, arrays::resortArray4>;
