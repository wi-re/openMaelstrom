...
namespace SPH{
	namespace Integration{
		struct Memory{
			...
			write_array_u<arrays::rigidLinearVelocities> rigidLinearVelocities;
			...
			using input_arrays = std::tuple<arrays::acceleration, arrays::volume, arrays::density, arrays::particle_type>;
			using output_arrays = std::tuple<arrays::lifetime, arrays::rigidLinearVelocities>;
			...
			using parameters = std::tuple<parameters::max_velocity, parameters::boundaryDampening, parameters::external_force, parameters::ptcl_support>;
