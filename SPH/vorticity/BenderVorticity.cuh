...
namespace SPH{
	namespace BenderVorticity{
		struct Memory{
			...
			// parameters
			parameter_u<parameters::intertiaInverse> intertiaInverse;
			parameter_u<parameters::viscosityOmega> viscosityOmega;
			parameter_u<parameters::vorticityCoeff> vorticityCoeff;
			...
			using parameters = std::tuple<parameters::intertiaInverse, parameters::viscosityOmega, parameters::vorticityCoeff>;
