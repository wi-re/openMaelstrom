...
namespace SPH{
	namespace Viscosity{
		struct Memory{
			...
			using parameters = std::tuple<parameters::monaghan_viscosity, parameters::blendSteps, parameters::boundaryViscosity>;
...
constexpr static const bool inlet = false;
		...
		inline bool valid(Memory){
			...
			condition = condition || get<parameters::modules::viscosity>() == true;
			return condition;
		}
