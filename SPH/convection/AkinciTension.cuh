...
namespace SPH{
	namespace AkinciTension{
		struct Memory{
			...
			parameter_u<parameters::rigidAdhesion_akinci> rigidAdhesion_akinci;
			parameter_u<parameters::boundaryAdhesion_akinci> boundaryAdhesion_akinci;
			...
			using parameters = std::tuple<parameters::tension_akinci, parameters::rigidAdhesion_akinci, parameters::boundaryAdhesion_akinci>;
