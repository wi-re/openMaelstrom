...
namespace SPH{
	namespace adaptive{
		struct Memory{
			...
			parameter_u<parameters::ratio> ratio;
			...
			parameter_u<parameters::resolution> resolution;
			parameter_u<parameters::delay> delay;
			parameter_u<parameters::blendSteps> blendSteps;
			parameter_u<parameters::useVolume> useVolume;
			parameter_u<parameters::adaptivityScaling> adaptivityScaling;
			parameter_u<parameters::adaptivityGamma> adaptivityGamma;
			parameter_u<parameters::adaptivityThreshold> adaptivityThreshold;
			...
			using input_arrays = std::tuple<arrays::boundaryPlanes>;
			using output_arrays = std::tuple<arrays::velocity, arrays::lifetime, arrays::density, arrays::splitIndicator, arrays::parentVolume>;
			using temporary_arrays = std::tuple<arrays::adaptive::classification, arrays::mergeCounter, arrays::markerBuffer, arrays::changeBuffer, arrays::mergeable, arrays::ptclCounter, arrays::particleIndex, arrays::particleIndexCompact, arrays::adaptivityCounter>;
			...
			using parameters = std::tuple<parameters::boundaryDampening, parameters::xsph_viscosity, parameters::ratio, parameters::surface_levelLimit, parameters::simulationTime, parameters::surface_neighborLimit, parameters::surface_phiMin, parameters::surface_phiChange, parameters::surface_distanceFieldDistances, parameters::resolution, parameters::delay, parameters::blendSteps, parameters::useVolume, parameters::adaptivityScaling, parameters::adaptivityGamma, parameters::adaptivityThreshold>;
