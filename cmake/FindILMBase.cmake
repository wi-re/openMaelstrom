...
IF ( BASE_BUILD_PATH ) 
  IF ( NOT ILMBASE_HOME )    
    SET ( ILMBASE_HOME ${BASE_BUILD_PATH}/IlmBase/ CACHE PATH "Path to ILMBase")
  ENDIF ( NOT ILMBASE_HOME )
ENDIF ( BASE_BUILD_PATH ) 

IF ( NOT ILMBASE_HOME )
   SET ( ILMBASE_HOME "" CACHE PATH "Path to ILMBase")
ENDIF ( NOT ILMBASE_HOME )
...
PREFIX_FIND_INCLUDE_DIR (IlmBase IlmBaseConfig.h IlmBase_include_paths)
...
if (ILMBASE_FOUND)
  ...
  message ( "IlmBase Library: NOT Found! Confirm that ILMBASE_HOME is set to IlmBase library." )
endif ()
