...
IF ( BASE_BUILD_PATH ) 
  IF ( NOT OPENEXR_HOME )    
    SET ( OPENEXR_HOME ${BASE_BUILD_PATH}/OpenEXR/ CACHE PATH "Path to OpenEXR")
  ENDIF ( NOT OPENEXR_HOME )
ENDIF ( BASE_BUILD_PATH ) 

IF ( NOT OPENEXR_HOME )
   SET ( OPENEXR_HOME "" CACHE PATH "Path to ILMBase")
ENDIF ( NOT OPENEXR_HOME )
...
PREFIX_FIND_INCLUDE_DIR (OpenEXR OpenEXRConfig.h OpenEXR_include_paths)
...
UNSET ( OPENEXR_FOUND CACHE )
if ( (EXISTS ${OPENEXR_INCLUDE_DIR}) )
  SET (OPENEXR_FOUND TRUE CACHE BOOL "")
else ()
  SET (OPENEXR_FOUND FALSE CACHE BOOL "")
endif ()
...
if (OPENEXR_FOUND)
  ...
  #)
   ...
   message ( "OpenEXR Library: NOT Found! Confirm that OPENEXR_HOME is set to OpenEXR library path." )
